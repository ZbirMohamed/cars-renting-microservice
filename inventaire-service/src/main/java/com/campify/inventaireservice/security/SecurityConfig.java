package com.campify.inventaireservice.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(ar->ar
                        ...
                        .requestMatchers(HttpMethod.GET,"/actuator/health","/inventaire/**").permitAll()
                        .requestMatchers(HttpMethod.PATCH,"/inventaire/**").permitAll()
                )
